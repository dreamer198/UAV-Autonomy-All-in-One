...
namespace fsm {
    ...
    public:
        ...
        double close_goal_threshold{};
        double click_height{};

        bool click_yaw_en{};
        string cmd_topic, mpc_cmd_topic, click_goal_topic;
        string heartbeat_topic, progress_topic, effective_goal_topic;
        string reset_service, validate_goal_service;
        double yaw_dot_max{};
        ...
        Config(const std::string & cfg_path) {
            ...
            loader.LoadParam("fsm/close_goal_threshold", close_goal_threshold, 0.1);
            ...
            loader.LoadParam("fsm/heartbeat_topic", heartbeat_topic, string("heartbeat"));
            loader.LoadParam("fsm/progress_topic", progress_topic, string("progress"));
            loader.LoadParam("fsm/effective_goal_topic", effective_goal_topic, string("effective_goal"));
            loader.LoadParam("fsm/reset_service", reset_service, string("reset"));
            loader.LoadParam("fsm/validate_goal_service", validate_goal_service, string("validate_goal"));
