...
private:
  ...
  double goal_yaw_;
  bool goal_yaw_constrained_;
  uint64_t active_goal_id_;
  int current_wp_;
  ...
  ros::Publisher replan_pub_, new_pub_, bspline_pub_, progress_pub_;
  ...
  void goalCallback(const plan_manage::FastPlannerGoalConstPtr& msg);
