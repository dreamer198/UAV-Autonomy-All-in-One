...
void ImuProcess::IMU_init(const MeasureGroup &meas, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state, int &N)
{
  ...
  // Match the stable ROS2 FAST-LIO initialization: keep the world frame
  // gravity-aligned and rotate the initial IMU body using the static mean
  // acceleration. This prevents a tilted MID360 mount from becoming a
  // tilted world frame in ROS1.
